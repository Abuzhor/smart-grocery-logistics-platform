...
Outcome-oriented; dates are indicative and will adjust based on learning.
...
Acceptance: Picker completes an order with or without substitution and records outcomes.
...
Acceptance: Dispatcher creates a route, assigns stops, and completes deliveries with basic ETA accuracy.
